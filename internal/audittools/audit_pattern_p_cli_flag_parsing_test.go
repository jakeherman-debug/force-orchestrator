...
func TestPattern_P_CLIFlagParsing(t *testing.T) {
	...
	allowlist := map[string]string{
		...
		"cmdMigrate":          "dispatcher — routes to pr-flow/classify-proposals (leaves call helper)",
		"cmdTags":             "dispatcher — routes to list/create/remove (leaves call parseSubcommandFlags)",
		"cmdRules":            "dispatcher — routes to list/upgrade (leaves call parseSubcommandFlags)",
		"cmdTagSuggestions":   "dispatcher — routes to list/accept/dismiss (leaves call parseSubcommandFlags)",
