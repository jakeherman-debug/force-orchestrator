...
func TestRerankFleetMemories_UsesLLMOrdering(t *testing.T) {
	...
	got := RerankFleetMemories(context.Background(), db, "improve auth flow", candidates, 5, mustLoadCapProfile(t, "librarian"), testLogger{})
	if len(got) != 2 {
...
func TestRerankFleetMemories_EmptySelectionIsValid(t *testing.T) {
	...
	got := RerankFleetMemories(context.Background(), db, "upgrade Go version in CI", candidates, 5, mustLoadCapProfile(t, "librarian"), testLogger{})
	if len(got) != 0 {
...
func TestRerankFleetMemories_KeepLimitCapsResults(t *testing.T) {
	...
	got := RerankFleetMemories(context.Background(), db, "anything", candidates, 2, mustLoadCapProfile(t, "librarian"), testLogger{})
	if len(got) != 2 {
...
func TestRerankFleetMemories_IgnoresOutOfRangeIDs(t *testing.T) {
	...
	got := RerankFleetMemories(context.Background(), db, "test", candidates, 5, mustLoadCapProfile(t, "librarian"), testLogger{})
	if len(got) != 2 {
...
func TestRerankFleetMemories_FallsBackOnClaudeError(t *testing.T) {
	...
	got := RerankFleetMemories(context.Background(), db, "test", candidates, 2, mustLoadCapProfile(t, "librarian"), testLogger{})
	if len(got) != 2 {
...
func TestRerankFleetMemories_FallsBackOnMalformedJSON(t *testing.T) {
	...
	got := RerankFleetMemories(context.Background(), db, "test", candidates, 3, mustLoadCapProfile(t, "librarian"), testLogger{})
	if len(got) != 3 {
...
func TestRerankFleetMemories_EmptyCandidates(t *testing.T) {
	...
	got := RerankFleetMemories(context.Background(), db, "test", nil, 5, mustLoadCapProfile(t, "librarian"), testLogger{})
	if got != nil {
