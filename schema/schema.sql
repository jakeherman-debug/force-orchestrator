...
CREATE TABLE IF NOT EXISTS CrossRepoAPIs (
    id               INTEGER PRIMARY KEY AUTOINCREMENT,
    repo_name        TEXT NOT NULL,
...
CREATE INDEX IF NOT EXISTS idx_cross_repo_apis_repo ON CrossRepoAPIs(repo_name);
CREATE INDEX IF NOT EXISTS idx_cross_repo_apis_ident ON CrossRepoAPIs(api_kind, api_identifier);
...
CREATE TABLE IF NOT EXISTS CrossRepoAPIDependencies (
    id               INTEGER PRIMARY KEY AUTOINCREMENT,
...
CREATE INDEX IF NOT EXISTS idx_cross_repo_api_deps_provider ON CrossRepoAPIDependencies(provider_api_id);
CREATE INDEX IF NOT EXISTS idx_cross_repo_api_deps_consumer ON CrossRepoAPIDependencies(consumer_repo);
