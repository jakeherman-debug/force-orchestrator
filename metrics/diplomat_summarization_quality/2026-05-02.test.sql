-- diplomat_summarization_quality@2026-05-02 fixture test.

INSERT INTO Experiments
    (id, name, hypothesis_text, stakes_tier, subject_agent, assignment_unit, status, created_by)
VALUES (1, 'fixture-diplomat_summarization_quality', 'fixture', 'low', 'diplomat', 'task', 'running', 'fixture');
...
VALUES (1, 100, 'diplomat', 'diplomat-v1', datetime('now'), 'sys', 'usr', 'ok response');
