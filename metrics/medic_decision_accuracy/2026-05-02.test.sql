-- medic_decision_accuracy@2026-05-02 fixture test.

INSERT INTO Experiments
    (id, name, hypothesis_text, stakes_tier, subject_agent, assignment_unit, status, created_by)
VALUES (1, 'fixture-medic_decision_accuracy', 'fixture', 'low', 'medic', 'task', 'running', 'fixture');
...
VALUES (1, 100, 'medic', 'medic-v1', datetime('now'), 'sys', 'usr', 'ok response');
