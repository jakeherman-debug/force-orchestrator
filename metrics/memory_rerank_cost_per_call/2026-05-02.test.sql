-- memory_rerank_cost_per_call@2026-05-02 fixture test.
--
-- One run against one task; two memory-rerank transcripts at $0.001 +
-- $0.003 → expected mean = $0.002.

INSERT INTO Experiments
    (id, name, hypothesis_text, stakes_tier, subject_agent, assignment_unit, status, created_by)
VALUES (1, 'fixture-memory_rerank', 'fixture', 'low', 'memory-rerank', 'task', 'running', 'fixture');
...
VALUES
    (1, 100, 'memory-rerank', 'memory-rerank-v1', datetime('now'), 'sys', 'usr', 'ok', 0.001),
    (2, 100, 'memory-rerank', 'memory-rerank-v1', datetime('now'), 'sys', 'usr', 'ok', 0.003);
