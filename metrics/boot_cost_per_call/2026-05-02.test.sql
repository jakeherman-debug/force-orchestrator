-- boot_cost_per_call@2026-05-02 fixture test.
--
-- One run against one task; two boot transcripts at $0.001 +
...
VALUES
    (1, 100, 'boot', 'boot-v1', datetime('now'), 'sys', 'usr', 'ok', 0.001),
    (2, 100, 'boot', 'boot-v1', datetime('now'), 'sys', 'usr', 'ok', 0.003);
