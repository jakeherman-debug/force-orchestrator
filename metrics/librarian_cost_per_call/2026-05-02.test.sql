-- librarian_cost_per_call@2026-05-02 fixture test.
--
-- One run against one task; two librarian transcripts at $0.001 +
-- $0.003 → expected mean = $0.002.

INSERT INTO Experiments
    (id, name, hypothesis_text, stakes_tier, subject_agent, assignment_unit, status, created_by)
VALUES (1, 'fixture-librarian', 'fixture', 'low', 'librarian', 'task', 'running', 'fixture');
...
VALUES
    (1, 100, 'librarian', 'librarian-v1', datetime('now'), 'sys', 'usr', 'ok', 0.001),
    (2, 100, 'librarian', 'librarian-v1', datetime('now'), 'sys', 'usr', 'ok', 0.003);
