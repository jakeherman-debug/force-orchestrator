-- commander_cost_per_call@2026-05-02 fixture test.
--
-- One run against one task; two commander transcripts at $0.001 +
-- $0.003 → expected mean = $0.002.

INSERT INTO Experiments
    (id, name, hypothesis_text, stakes_tier, subject_agent, assignment_unit, status, created_by)
VALUES (1, 'fixture-commander', 'fixture', 'low', 'commander', 'task', 'running', 'fixture');
...
VALUES
    (1, 100, 'commander', 'commander-v1', datetime('now'), 'sys', 'usr', 'ok', 0.001),
    (2, 100, 'commander', 'commander-v1', datetime('now'), 'sys', 'usr', 'ok', 0.003);
