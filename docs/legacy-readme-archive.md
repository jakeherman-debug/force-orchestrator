<!-- D13 P1 ARCHIVE — pre-shard README content. P2 migrates each section into its proper destination
     (subsystems/*, agents/*, references/, overview.md, onboarding.md, operator-runbook.md)
     and deletes this file at the end of P2. Treat as a content source, not a published doc. -->

---
audience: operator
scope: Pre-D13 README content preserved for P2 migration; do not link to this file.
owner: D13
